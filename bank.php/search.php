...
if(!empty($_POST["Ac_No"])){
    ...
    if ($result !== false && $result->num_rows > 0) {
        ...
        while($result !== false && $row = $result->fetch_assoc()) {
            ...
            <div id='tablebar'><p><table><tr><td>Name</td><td>: &nbsp&nbsp&nbsp&nbsp ".$row["Name1"]."</td></tr><tr><td>Age</td><td>: &nbsp&nbsp&nbsp&nbsp ".$row["Age"]."</td></tr><tr><td>Gender</td><td>: &nbsp&nbsp&nbsp&nbsp ".$row["Gender"]."</td></tr><tr><td>Date of birth</td><td>: &nbsp&nbsp&nbsp&nbsp".$row["Date_of_birth"]."</td></tr><tr><td>Email</td><td>: &nbsp&nbsp&nbsp&nbsp".$row["Email"]."</td></tr><tr><td>Phone Number</td><td>: &nbsp&nbsp&nbsp&nbsp   ".$row["Ph_No"]."</td></tr><tr><td>Aadhar Number</td><td>: &nbsp&nbsp&nbsp&nbsp ".$row["Aadhar_No"]."</td></tr></table></p></div>
        </div>
    ";}
      }
      else{
